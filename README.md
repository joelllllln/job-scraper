...
2233 firms, London-focused. Front office and market-facing roles only.
...
| `links.md` | already generated, 2233 firms |

## Why discovery instead of hardcoded URLs

I don't have a reliable way to know which ATS each of 2233 firms uses, and
